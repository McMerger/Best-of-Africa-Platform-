...
export const BetaAbout = () => {
  ...
  return (
    <div className="selection:bg-accent selection:text-primary bg-primary text-primary-foreground min-h-screen">
      <SEO 
      ...
      {/* 1. HERO */}
      <section className="relative min-h-[80vh] flex flex-col justify-center pt-24 pb-24 px-6 border-b border-white/10 overflow-hidden">
        <motion.div 
      ...
      {stats && (
        <section className="border-b border-white/10 bg-card/50 relative z-30 backdrop-blur-md">
          <div className="max-w-5xl mx-auto px-6 py-12 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <motion.div key={label} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}>
                ...
                <p className="text-[11px] text-white/50 uppercase tracking-widest font-bold">{label}</p>
              </motion.div>
            ))}
          </div>
        </section>
      ...
      <main className="max-w-4xl mx-auto px-6">
        ...
        <section className="py-32 border-b border-white/10">
          <motion.div 
            ...
            className="prose prose-lg max-w-none prose-p:font-serif prose-p:text-[2rem] prose-p:md:text-[3rem] prose-p:leading-[1.4] prose-p:text-white/90 prose-p:tracking-tight"
          >
            <p className="mb-12">
        ...
        <section className="py-32 border-b border-white/10">
          <motion.h2 
            ...
            className="font-serif text-[3rem] md:text-[4rem] mb-16 text-center md:text-left text-white leading-none"
          >
            What this actually is
          </motion.h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="bg-card p-10 rounded-3xl border border-white/10 hover:border-accent/50 hover:shadow-[0_10px_40px_rgba(212,175,55,0.1)] transition-all">
              <span className="text-4xl block mb-8 drop-shadow-sm">✍️</span>
              <h3 className="font-serif text-[2rem] mb-4 text-white">Real Stories</h3>
              <p className="text-white/60 text-[1.125rem] leading-[1.8]">
            ...
            <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="bg-card p-10 rounded-3xl border border-white/10 hover:border-accent/50 hover:shadow-[0_10px_40px_rgba(212,175,55,0.1)] transition-all">
              <span className="text-4xl block mb-8 drop-shadow-sm">🚫</span>
              <h3 className="font-serif text-[2rem] mb-4 text-white">Narrative Correction</h3>
              <p className="text-white/60 text-[1.125rem] leading-[1.8]">
        ...
        <section className="py-32 border-b border-white/10">
          <motion.h2 
            initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            className="font-serif text-[3rem] md:text-[4rem] mb-12 text-center md:text-left text-white leading-none"
          >
            Why Ko-fi?
          </motion.h2>
          <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="prose max-w-4xl prose-p:text-[1.25rem] prose-p:leading-[1.8] text-white/70 font-light">
            <p className="mb-8">
        ...
        <section className="py-40 text-center relative z-10">
          <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }}>
            ...
            <h2 className="font-serif text-[3rem] md:text-[5rem] leading-[0.9] tracking-tighter mb-12 text-white drop-shadow-xl">
