                ...
                <div className="prose prose-lg dark:prose-invert max-w-none">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 not-prose my-8">
                        <div className="p-6 border border-border rounded-lg bg-card">
                            ...
                            <p className="text-sm text-muted-foreground">Premium pan-African content platform.</p>
                        </div>
                        <div className="p-6 border border-border rounded-lg bg-card">
                        ...
                        <div className="p-6 border border-border rounded-lg bg-card">
                            ...
                            <p className="text-sm text-muted-foreground">Amplifying Africa's voice with rigor.</p>
                        </div>
                        <div className="p-6 border border-border rounded-lg bg-card">
                            <h4 className="font-bold text-primary mb-2">Business Gateway</h4>
                            <p className="text-sm text-muted-foreground">Trusted portal for opportunity.</p>
                        </div>
                    </div>
                </div>
            </div>
