    ...
    return (
        <Popover open={isOpen} onOpenChange={setPanelOpen}>
            ...
            <PopoverContent className="w-[400px] p-0" align="end">
                <div className="flex flex-col h-[600px] overflow-hidden bg-card border border-border/50 shadow-2xl">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-8">
                            ...
                            <div className="flex gap-2">
                                {(['deep', 'brief', 'audio'] as MissionFormat[]).map((f) => (
                                    <Badge
                                        ...
                                        variant="outline"
                                        className={cn(
                                            "cursor-pointer px-3 py-1.5 capitalize transition-all",
                                            format === f
                        ...
                        <section>
                            ...
                            <div className="mb-4">
                                <div className="text-[10px] font-bold mb-2">Priority Markets</div>
                                <div className="flex flex-wrap gap-1.5">
                                    {availableCountries.slice(0, 12).map(c => (
                                        <Badge
                                            ...
                                            className={cn(
                                                "cursor-pointer text-[10px] border-border/50 transition-all",
                            ...
                            <div>
                                <div className="text-[10px] font-bold mb-2">Strategic Sectors</div>
                                <div className="flex flex-wrap gap-1.5">
