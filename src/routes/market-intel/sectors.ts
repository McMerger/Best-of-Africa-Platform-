        ...
        ai_trend_analysis: await getCached(
            ...
            async () => {
                try {
                    ...
                    const aiResponse = await callConfiguredAI(c.env, { prompt: `${prompt}\n\nProvide a full evidence synthesis with chronology, actors, documented mechanisms, country differences, stakeholder effects, first- and second-order implications, contradictions, alternative explanations, limitations, source gaps, claim ledger and verification priorities.`, max_tokens: 4800, temperature: 0.2, response_profile: 'deep-analysis' });
