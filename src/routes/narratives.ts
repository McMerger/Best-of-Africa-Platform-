    ...
    const narrativeArc = await getCached(
        ...
        async () => {
            ...
            try {
                ...
                const aiResponse = await callConfiguredAI(c.env, { prompt: `${prompt}\n\nProvide a detailed synthesis with dated evidence, competing narratives, source limitations, affected stakeholders, and what requires verification. Do not infer unsupported sentiment or impact.`, max_tokens: 3200, temperature: 0.2, response_profile: 'deep-analysis' });
